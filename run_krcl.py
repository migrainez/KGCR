...
if __name__ == '__main__':
    try:
        ...
        logging.basicConfig(filename='logs/{}/kgcl.log'.format(args.dataset), level=logging.DEBUG)
        ...
        for epoch in range(args.epoch):
            ...
            if epoch >= 1:
                ...
                train_res.field_names = ["Epoch", "training time", "tesing time", "Loss","edge_attention", "recall", "ndcg", "precision", "hit_ratio"]
                train_res.add_row(
                    [epoch, train_e_t - train_s_t, test_e_t - test_s_t, list(add_loss_dict.values()),edge_attention.std().item(), ret['recall'], ret['ndcg'], ret['precision'], ret['hit_ratio']]
                )
                ...
                if ret['recall'][0] == cur_best_pre_0 and args.save:
                    save_path = args.out_dir + args.dataset + '.ckpt'
